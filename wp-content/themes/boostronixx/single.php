...
<main id="article">
      <article>
        ...
        <div class="mx-auto max-w-5xl px-4 sm:px-6 mt-6">
          <img src="<?php echo esc_url( $bx_banner_url ); ?>" alt="<?php echo esc_attr( get_the_title() ); ?>" class="w-full rounded-xl2" style="max-height:520px;object-fit:cover" loading="eager" />
        </div>
        <?php endif; ?>
          ...
          <div class="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            <div class="grid sm:grid-cols-3 gap-6">
              ...
              <a href="<?php the_permalink(); ?>" class="relpost group block">
                <div class="relimg imgph rounded-xl2 aspect-[3/4]"><div class="ph-zoom absolute inset-0 z-0" style="background:<?php echo esc_attr( $bx_relgrads[ $bx_ri % 3 ] ); ?>" aria-hidden="true"></div><?php if ( has_post_thumbnail() ) : ?><img src="<?php echo esc_url( get_the_post_thumbnail_url( null, 'bx-blog-cover' ) ); ?>" alt="<?php echo esc_attr( get_the_title() ); ?>" loading="lazy" /><?php endif; ?></div>
