 ...
 * Template Name: Blog
 *
 * Dynamic blog listing: pulls real WP posts into the original design's
 * featured + card grid. Category chips are built from the post categories;
 * the client-side search/filter (app.js) works on the rendered cards.
 *
 * @package BoostronixX
 */
